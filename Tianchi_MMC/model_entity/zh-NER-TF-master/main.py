...
parser.add_argument('--train_data', type=str, default='data_tnb\\ruijin_train', help='train data source')
parser.add_argument('--test_data', type=str, default='data_tnb\\ruijin_test', help='test data source')
parser.add_argument('--batch_size', type=int, default=64, help='#sample of each minibatch')
parser.add_argument('--epoch', type=int, default=160, help='#epoch of training')
...
if args.mode == 'train':
    ...
    data = read_corpus(args.train_data)
    sp = int(0.8*len(data))
    train_data = data[:sp]
    dev_data = data[sp:]
